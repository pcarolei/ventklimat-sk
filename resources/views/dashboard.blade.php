<x-app-layout>
    ...
    <div class="page-content">
        {{-- Проверяем роль пользователя перед отображением статистики и последних заказов --}}
        ...
        @else
            {{-- Сообщение для клиента, если он все же попал на дашборд (хотя мы его закроем через маршрут) --}}
            <p>Добро пожаловать в личный кабинет! Используйте навигацию для управления вашими заказами.</p>
        @endif
    </div>
</x-app-layout>
