<x-app-layout>
    ...
    <div class="page-content">
        <div class="form-card"> {{-- Новый класс для карточки формы --}}
            <form method="POST" action="{{ route('orders.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="total_amount" name="total_amount" type="number" step="0.01" min="0" class="form-group-input" value="{{ old('total_amount', 0) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="details" name="details" class="form-group-input" rows="4">{{ old('details') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    {{-- Используем multiple select для выбора нескольких услуг --}}
